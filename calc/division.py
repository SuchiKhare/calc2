"""This is the division calculation that is being
...
# It looks like a folder and file path but it is sort of a
# virtual representation of how the program is organized
...
class Division(Calculation):
    ...
    get the result of the the calculation A and B come
    from the calculation parent class"""

    def get_result(self):
        """you need to use self to reference the data contained in the
        instance of the object.  This is encapsulation"""
        try:
            return self.value_a / self.value_b
        except ZeroDivisionError as myerr:
            raise ZeroDivisionError from myerr
