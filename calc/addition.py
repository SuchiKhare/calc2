...
# It looks like a folder and file path but it is sort of
# a virtual representation of how the program is organized
...
class Addition(Calculation):
    ...
    of the the calculation A and B come from  the calculation
     parent class"""
